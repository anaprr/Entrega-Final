...
namespace Projeto_Final.Controllers
{
    public class SaidaProdutoController : Controller
    {
        ...
        {
            var contexto = _context.SaidaProduto.Include(s => s.Cidade).Include(s => s.Produto).Include(s => s.TipoSaida).Include(s => s.Usuario);
        ...
        public async Task<IActionResult> Create([Bind("Id,ProdutoId,SaidaData,QuantidadeSaida,UsuarioId,CidadeId,TipoSaidaId")] SaidaProduto saidaProduto)
        {
            ...
            ViewData["CidadeId"] = new SelectList(_context.Cidade, "Id", "CidadeNome", saidaProduto.CidadeId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProdutoId,SaidaData,QuantidadeSaida,UsuarioId,CidadeId,TipoSaidaId")] SaidaProduto saidaProduto)
        {
