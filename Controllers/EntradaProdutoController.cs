...
namespace Projeto_Final.Controllers
{
    public class EntradaProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProdutoId,EntradaData,QuantidadeEntrada")] EntradaProduto entradaProduto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProdutoId,EntradaData,QuantidadeEntrada")] EntradaProduto entradaProduto)
        {
