...
namespace Projeto_Final.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeProduto,QuantidadeEstoque,TipoProdutoId,FornecedorId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeProduto,QuantidadeEstoque,TipoProdutoId,FornecedorId")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
